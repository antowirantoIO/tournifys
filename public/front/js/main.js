...
function mainSlider() {
	...
	BasicSlider.slick({
		...
		fade: true,
		arrows: true,
		prevArrow: '<button type="button" class="slick-prev"><img src="https://themebeyond.com/html/geco/Geco/img/icon/arrow_left.png" alt=""></button>',
		nextArrow: '<button type="button" class="slick-next"><img src="https://themebeyond.com/html/geco/Geco/img/icon/arrow_right.png" alt=""></button>',
		responsive: [
